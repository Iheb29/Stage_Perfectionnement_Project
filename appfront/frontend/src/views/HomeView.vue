  ...
  <div class="home">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
            ...
            <div class="container px-4 px-lg-5 h-100">
                <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-8 align-self-end">
                        <h1 class="text-white font-weight-bold">Les Ciments De Bizerte</h1>
                        <hr class="divider" />
                    </div>
        ...
        <footer class="bg-light py-5">
            <div class="container px-4 px-lg-5"><div class="small text-center text-muted">Copyright &copy; 2024 - Les Ciments De Bizerte</div></div>
        </footer>
  </div>
</template>
...
header.masthead {
  ...
  background: linear-gradient(to bottom, rgba(92, 77, 66, 0.8) 0%, rgba(92, 77, 66, 0.8) 100%), url("../assets/imagehome2.jpg");
  background-position: center;
  background-repeat: no-repeat;
